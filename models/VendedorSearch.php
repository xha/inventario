...
class VendedorSearch extends Vendedor
{
    ...
    public function search($params)
    {
        ...
        $query->andFilterWhere([
            ...
            'fecha' => $this->fecha,
            'esComisionVenta' => $this->esComisionVenta,
            'esComisionCobro' => $this->esComisionCobro,
            'esComisionTabuladorVenta' => $this->esComisionTabuladorVenta,
            'esComisionTabuladorCobro' => $this->esComisionTabuladorCobro,
